...
// Code:
// Date: 2025.06.20  Ver.: 0.0.1
// H/W Target: ARDUINO UNO R3, S/W: Arduino IDE  2.3.6
...
#define ATS08_ID_VDD    0x59 //0xB2 >>1( 0b1011001 7bit + R/W 1 Bit, 7bit=0x59, 8bit=0xB2)
...
void  Init_ATS08(void)
{
   ...
   Wire.endTransmission(); //
   delay(100); // Wait for S/W Reset to complete.
...
//------------------ LED PWM Setting Register ----------------------
   ...
   Wire.write(byte(0x03)); // Single/Mulit Mode, INT Pin Mode, Touch Debounce Count
   Wire.endTransmission(); //
